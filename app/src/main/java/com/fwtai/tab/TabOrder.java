...
*/
public final class TabOrder extends BaseFragment implements OnClickListener{
	...
	public View onCreateView(final LayoutInflater inflater,final ViewGroup container,final Bundle bundle) {
		...
		mView = inflater.inflate(R.layout.tab_layout_order,null,false);
		initView();
		return mView;
	}
	
	private void initView() {
		titleBar = (TitleBar) mView.findViewById(R.id.title_bar_order);
		titleBar.removeBorderView();
		titleBar.setTitle(getString(R.string.tab_flag_tv_order));
	}
